...
NNODES=1
NPROC_PER_NODE=8
SAVE_DIR="/data/temp/Expire180Days/users/luobwang/diffusion_planner_train_log"
...
if [ -z "$JOB_NAME" ]; then
    JOB_NAME="diffusion_planner_${MAX_FILES}_samples-${NUM_OBSERVED}_observed-${NUM_PREDICTED}_predicted"
fi
