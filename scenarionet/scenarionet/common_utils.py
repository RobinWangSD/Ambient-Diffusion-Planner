...
def read_dataset_summary(dataset_path, check_file_existence=True):
    ...
    """
    return sd_utils.read_dataset_summary(dataset_path, check_file_existence=check_file_existence)


def read_scenario(dataset_path, mapping, scenario_file_name, centralize=False):
    ...
    """
    return sd_utils.read_scenario_data(os.path.join(dataset_path, mapping[scenario_file_name], scenario_file_name), centralize=centralize)
