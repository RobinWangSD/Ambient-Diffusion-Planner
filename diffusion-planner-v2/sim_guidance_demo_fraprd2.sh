...
# Configuration
ARGS_FILE="/data/temp/Expire180Days/users/luobwang/diffusion_planner_checkpoints/args.json"
CKPT_FILE="/data/temp/Expire180Days/users/luobwang/diffusion_planner_checkpoints/model.pth"
SPLIT="test14-random"
...
python /root/planning-intern/nuplan-devkit/nuplan/planning/script/run_simulation.py \
    ...
    experiment_uid=diffusion_planner/${SPLIT}_collision_guidance \
    verbose=true \
